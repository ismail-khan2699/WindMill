...
const Whatwedo = () => {
  ...
  return (
    ...
    <h2 className=" text-xl  md:text-3xl leading-5 text-black font-bold">Windmill Strategy is an industrial web design and B2B digital marketing agency that helps companies with complex offerings attract and convert their ideal audiences</h2>
  ...
  {list.map((data, index) => (
    <div key={index} className="flex  py-2 justify-start">
      <span className=" text-gray-500 mx-2">&#8226;</span>{data.data}
    </div>
  ))}
</div>
